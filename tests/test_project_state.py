...
class ProjectStateTests(unittest.TestCase):
    ...
    def test_checkpoint_baseline_preserves_each_attributed_real_override(self):
        ...
        self.assertEqual(len(post_checkpoint), 14)
        ...
        self.assertIn("GATE: Git hook resolver", post_checkpoint[7])
        self.assertIn("Preview 0.11 P04/P05 release candidate", post_checkpoint[7])
        self.assertIn("GATE: Git hook resolver", post_checkpoint[8])
        self.assertIn("Preview 0.11 installer-digest correction", post_checkpoint[8])
        self.assertIn("GATE: Git hook resolver", post_checkpoint[9])
        self.assertIn("independent-review README inventory correction", post_checkpoint[9])
        self.assertIn("GATE: Git hook resolver", post_checkpoint[10])
        ...
        self.assertIn("private P06 integration onto the isolated Preview 0.12 candidate", post_checkpoint[13])
