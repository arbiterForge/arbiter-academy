...
_REVIEWED_IMMUTABLE_RELEASE_COMMITS = {
    ...
    "preview-0.8": "966a0aba5946e94b95a37d0a055503384214485e",
    "preview-0.9": "27b88aa3e6286a3b3eff43f17bed855b2d582e15",
}
...
class ReleaseAssetBuilderTests(unittest.TestCase):
    def test_preview_zero_twenty_seven_is_the_only_current_candidate_identity(self) -> None:
        """Catches current assets drifting while Preview 0.9 history remains intact."""
        self.assertEqual(RELEASE, "preview-0.29")
        self.assertEqual(EPOCH, 1_786_752_000)
        ...
        self.assertIn("academy/publication/preview-0.29.json", package)
    ...
    def test_preview_zero_nine_retains_its_reviewed_immutable_history(self) -> None:
        """Preview 0.14 promotion must not rewrite Preview 0.9 tag semantics."""
        self.assertEqual(
            _REVIEWED_IMMUTABLE_RELEASE_COMMITS["preview-0.9"],
            "27b88aa3e6286a3b3eff43f17bed855b2d582e15",
        )
    ...
    def test_current_preview_uses_its_tag_as_soon_as_publication_creates_it(self) -> None:
        """A published Preview 0.14 must stop selecting mutable candidate bytes."""
        expected = "a" * 40
        ...
        self.assertEqual(
            ...
            ["git", "rev-parse", "--verify", "refs/tags/preview-0.29^{commit}"],
        )
            ...
            self.assertEqual(
                {
                    ...
                    if "/academy/actions/P03" in name
                },
...
class InstallerBehaviorTests(unittest.TestCase):
    ...
    def test_powershell_redirect_validator_rejects_nondefault_https_ports(self) -> None:
        ...
        harness.write_text(
            ...
            "$github = [Uri]'https://github.com/arbiterForge/arbiter-academy/releases/download/preview-0.29/file.zip'\n"
