...
class U02AuditGuardObservationTests(unittest.TestCase):
    ...
    def test_u02_rejects_forged_event_modified_log_extra_path_dirty_tree_and_multiple_commits(self) -> None:
        cases = {
            "wrong-guard": {"event": "BLOCKED [H-06]: wrong guard"},
            "forged-h05-message": {"event": "BLOCKED [H-05]: audit history is append-only"},
