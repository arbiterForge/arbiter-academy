...
class CheckpointTests(unittest.TestCase):
    def setUp(self):
        ...
        self.write({"schema_version": 1, "id": "F01-fork-clone-doctor", "predicates": [{"id": "artifact", "type": "file_contains", "path": ".codearbiter/specs/proof.md", "text": "approved"}]})
    ...
    def test_passing_command_does_not_replace_missing_governed_artifact(self):
        self.write({"schema_version": 1, "id": "F01-fork-clone-doctor", "predicates": [{"id": "artifact", "type": "file_exists", "path": ".codearbiter/specs/proof.md"}]})
    ...
    def test_definition_rejects_unknown_unsafe_and_unbounded_values(self):
        for predicate in ({"id":"x","type":"unknown"}, {"id":"x","type":"file_exists","path":"../private"}, {"id":"x","type":"command_success","argv":["x"],"timeout_seconds":999}):
            with self.subTest(predicate=predicate):
                self.write({"schema_version":1,"id":"F01-fork-clone-doctor","predicates":[predicate]})
    ...
    def test_wrong_branch_fails_recomputed_git_evidence(self):
        ...
        self.write({"schema_version":1,"id":"F01-fork-clone-doctor","predicates":[{"id":"branch","type":"git_branch","branch":"academy/F01-fork-clone-doctor/1"}]})
        self.assertFalse(evaluate_checkpoint(self.root, "F01-fork-clone-doctor").passed)
