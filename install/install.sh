...
ARCHIVE_NAME='arbiter-academy-preview-0.22.zip'
BUNDLE_SHA256='2409685e40f373a1f983a5be25be55a6cf067b56edd00a4194b51c832272257b'
ASSET_URL='https://github.com/arbiterForge/arbiter-academy/releases/download/preview-0.22/arbiter-academy-preview-0.22.zip'
BUNDLE_PATH=''
...
case "$install_root" in "$academy_root"/preview-0.22) ;; *) die 'installer path escapes the user-owned Academy directory' ;; esac
...
work_root=$academy_root/.preview-0.22-install-$$
case "$work_root" in "$academy_root"/.preview-0.22-install-*) ;; *) die 'invalid installer work path' ;; esac
