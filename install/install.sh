...
ARCHIVE_NAME='arbiter-academy-preview-0.10.zip'
BUNDLE_SHA256='a34a51dad54f72b5a610d845c429f31426b4d2ea13d7525e969f15a6aaf1bfff'
ASSET_URL='https://github.com/arbiterForge/arbiter-academy/releases/download/preview-0.10/arbiter-academy-preview-0.10.zip'
BUNDLE_PATH=''
...
case "$install_root" in "$academy_root"/preview-0.10) ;; *) die 'installer path escapes the user-owned Academy directory' ;; esac
...
work_root=$academy_root/.preview-0.10-install-$$
case "$work_root" in "$academy_root"/.preview-0.10-install-*) ;; *) die 'invalid installer work path' ;; esac
