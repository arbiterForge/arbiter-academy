...
BUNDLE_SHA256='c61b6927372017d4ddf437824dac0ef945256ff8f2047665164153634989d76e'
...
case "$install_root" in "$academy_root"/preview-0.4) ;; *) die 'installer path escapes the user-owned Academy directory' ;; esac
...
work_root=$academy_root/.preview-0.4-install-$$
case "$work_root" in "$academy_root"/.preview-0.4-install-*) ;; *) die 'invalid installer work path' ;; esac
