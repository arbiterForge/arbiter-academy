...
RELEASE='preview-0.9'
ARCHIVE_NAME='arbiter-academy-preview-0.9.zip'
BUNDLE_SHA256='89aae947c2cb871c55324a7f29d9cea7dcb0d79d48560b6f0261d8c4546db111'
ASSET_URL='https://github.com/arbiterForge/arbiter-academy/releases/download/preview-0.9/arbiter-academy-preview-0.9.zip'
BUNDLE_PATH=''
...
case "$install_root" in "$academy_root"/preview-0.9) ;; *) die 'installer path escapes the user-owned Academy directory' ;; esac
...
work_root=$academy_root/.preview-0.9-install-$$
case "$work_root" in "$academy_root"/.preview-0.9-install-*) ;; *) die 'invalid installer work path' ;; esac
