...
ARCHIVE_NAME='arbiter-academy-preview-0.21.zip'
BUNDLE_SHA256='f42e301a813546748dbc7c9ef55deba9fcc8f5689d92e598d47eec609a6c5d95'
ASSET_URL='https://github.com/arbiterForge/arbiter-academy/releases/download/preview-0.21/arbiter-academy-preview-0.21.zip'
BUNDLE_PATH=''
...
case "$install_root" in "$academy_root"/preview-0.21) ;; *) die 'installer path escapes the user-owned Academy directory' ;; esac
...
work_root=$academy_root/.preview-0.21-install-$$
case "$work_root" in "$academy_root"/.preview-0.21-install-*) ;; *) die 'invalid installer work path' ;; esac
