...
ARCHIVE_NAME='arbiter-academy-preview-0.26.zip'
BUNDLE_SHA256='5a8e5130f9cd2826433c4eea02baea9c5013fe4b68a01a8ee9ec92e5840461b9'
ASSET_URL='https://github.com/arbiterForge/arbiter-academy/releases/download/preview-0.26/arbiter-academy-preview-0.26.zip'
BUNDLE_PATH=''
...
case "$install_root" in "$academy_root"/preview-0.26) ;; *) die 'installer path escapes the user-owned Academy directory' ;; esac
...
work_root=$academy_root/.preview-0.26-install-$$
case "$work_root" in "$academy_root"/.preview-0.26-install-*) ;; *) die 'invalid installer work path' ;; esac
