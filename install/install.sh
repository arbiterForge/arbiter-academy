...
ARCHIVE_NAME='arbiter-academy-preview-0.28.zip'
BUNDLE_SHA256='ffd5c55e3c72ddd889f1e68b0f57045653c87e4c9c71ed84c12e6ddd2a4cd398'
ASSET_URL='https://github.com/arbiterForge/arbiter-academy/releases/download/preview-0.28/arbiter-academy-preview-0.28.zip'
BUNDLE_PATH=''
...
case "$install_root" in "$academy_root"/preview-0.28) ;; *) die 'installer path escapes the user-owned Academy directory' ;; esac
...
work_root=$academy_root/.preview-0.28-install-$$
case "$work_root" in "$academy_root"/.preview-0.28-install-*) ;; *) die 'invalid installer work path' ;; esac
