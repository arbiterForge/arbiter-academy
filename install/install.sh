...
ARCHIVE_NAME='arbiter-academy-preview-0.27.zip'
BUNDLE_SHA256='5d7e53104b3e5929625c47d1b7674b13b149683db11deaf96908407796d9fced'
ASSET_URL='https://github.com/arbiterForge/arbiter-academy/releases/download/preview-0.27/arbiter-academy-preview-0.27.zip'
BUNDLE_PATH=''
...
case "$install_root" in "$academy_root"/preview-0.27) ;; *) die 'installer path escapes the user-owned Academy directory' ;; esac
...
work_root=$academy_root/.preview-0.27-install-$$
case "$work_root" in "$academy_root"/.preview-0.27-install-*) ;; *) die 'invalid installer work path' ;; esac
