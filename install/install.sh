...
ARCHIVE_NAME='arbiter-academy-preview-0.29.zip'
BUNDLE_SHA256='1b1036b41b258d5fea1723b0e233b0334e0298e10c09469fd0c1ab8083e7c0bf'
ASSET_URL='https://github.com/arbiterForge/arbiter-academy/releases/download/preview-0.29/arbiter-academy-preview-0.29.zip'
BUNDLE_PATH=''
...
case "$install_root" in "$academy_root"/preview-0.29) ;; *) die 'installer path escapes the user-owned Academy directory' ;; esac
...
work_root=$academy_root/.preview-0.29-install-$$
case "$work_root" in "$academy_root"/.preview-0.29-install-*) ;; *) die 'invalid installer work path' ;; esac
