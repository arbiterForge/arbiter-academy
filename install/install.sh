...
ARCHIVE_NAME='arbiter-academy-preview-0.14.zip'
BUNDLE_SHA256='8355ea9ee609d8d36f9bc56aa8ec3deeca7afde1f03fa21627b090f369a08bc1'
ASSET_URL='https://github.com/arbiterForge/arbiter-academy/releases/download/preview-0.14/arbiter-academy-preview-0.14.zip'
BUNDLE_PATH=''
...
case "$install_root" in "$academy_root"/preview-0.14) ;; *) die 'installer path escapes the user-owned Academy directory' ;; esac
...
work_root=$academy_root/.preview-0.14-install-$$
case "$work_root" in "$academy_root"/.preview-0.14-install-*) ;; *) die 'invalid installer work path' ;; esac
