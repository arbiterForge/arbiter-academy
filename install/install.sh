...
ARCHIVE_NAME='arbiter-academy-preview-0.25.zip'
BUNDLE_SHA256='1ffaed6a1aba228a01d65aee0c63041e344599ed8fdc36a91a8732ef03742172'
ASSET_URL='https://github.com/arbiterForge/arbiter-academy/releases/download/preview-0.25/arbiter-academy-preview-0.25.zip'
BUNDLE_PATH=''
...
case "$install_root" in "$academy_root"/preview-0.25) ;; *) die 'installer path escapes the user-owned Academy directory' ;; esac
...
work_root=$academy_root/.preview-0.25-install-$$
case "$work_root" in "$academy_root"/.preview-0.25-install-*) ;; *) die 'invalid installer work path' ;; esac
