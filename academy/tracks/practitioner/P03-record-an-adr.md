...
P03 is a private, source-only guided lesson. The current public release is Preview 0.6: it publishes
F01 and F02, lists P03 as `coming_next`, and does not permit P03 Prepare, Check, or Reset. There is no
...
No P03 learner Check can pass on Preview 0.6. After a future published Check actually passes, leave
