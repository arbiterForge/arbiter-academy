...
**Guided: F01 through F03.** Every user action, surface, expected result, and recovery path is explicit.

**Coming next: F04 and P01 through P07.** These lessons are not public Academy routes yet. Each appears here only after its guided rewrite and acceptance evidence are complete.

**Not yet scheduled.** P08 and the Power User lessons are not included in Preview 0.6.
