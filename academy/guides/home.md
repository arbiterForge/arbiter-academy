...
Doctor is a readiness check. It reports whether the repository, remotes, host, and Academy installation are ready before a lesson can change anything.

{{action:home-doctor}}

## Choose your first lesson

Start with F01, Fork, clone, and Doctor. Read the complete F01 page in the Browser, then use the Academy console only when the lesson tells you to prepare, inspect, check, reset, or return to base.
